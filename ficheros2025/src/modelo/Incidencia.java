...
public class Incidencia {
    ...
    public String toString() {
        //hota formateada porque aparecían milisegundos en el registro de incidencias
        //implementamos un formato predefinido en segundos
        DateTimeFormatter horaFormateada = DateTimeFormatter.ofPattern("HH:mm:ss");

        //formato con el que se imprimirá cada incidencia
